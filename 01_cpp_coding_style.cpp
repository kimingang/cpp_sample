...
class FODeleteElement{#include <iostream>
#include <sstream>
#include <string>
#include <vector>
#include <list>
...
- Comments use C++ basic format for full explanation, and detailed comments in code use Doxygen format.
///<		: to be syntax + comment same line  : while(n < 0) ///< number count loop
